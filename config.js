...
export const config = {
  ...
  management: {
    ...
    autoSwapMinUsd:        u.autoSwapMinUsd        ?? 0.5,
    ...
    stopLossCooldownHours: Number(u.stopLossCooldownHours ?? 2),
    negativePnlCooldownHours: Number(u.negativePnlCooldownHours ?? 2),
    ...
    trailTiers:            u.trailTiers            ?? null, // progressive tiers "activatePct:trailPct,..." e.g. "30:15,60:20,100:30"
  ...
  llm: {
    ...
    fallbackModels:  u.fallbackModels  ?? [],
  },
  ...
  indicators: {
    ...
    extensionFloorBand: indicatorUserConfig.extensionFloorBand ?? "middle",
  },
};
