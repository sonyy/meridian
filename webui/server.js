...
app.get("/api/positions", async (req, res) => {
  try {
    ...
    trailTiers: config.management?.trailTiers ?? null,
        ...
        minFeeActiveTvlRatio: config.screening?.minFeeActiveTvlRatio ?? null,
        minTvl: config.screening?.minTvl ?? null,
        maxTvl: config.screening?.maxTvl ?? null,
        minVolume: config.screening?.minVolume ?? null,
        minOrganic: config.screening?.minOrganic ?? null,
        minHolders: config.screening?.minHolders ?? null,
        minMcap: config.screening?.minMcap ?? null,
        maxMcap: config.screening?.maxMcap ?? null,
        minTokenAgeHours: config.screening?.minTokenAgeHours ?? null,
        maxTokenAgeHours: config.screening?.maxTokenAgeHours ?? null,
